...
const (
	FilmService_GetFilmDetails_FullMethodName = "/FilmService/GetFilmDetails"
)
...
type FilmServiceClient interface {
	GetFilmDetails(ctx context.Context, in *GetFilmDetailsRequest, opts ...grpc.CallOption) (*GetFilmDetailsResponse, error)
}
...
func (c *filmServiceClient) GetFilmDetails(ctx context.Context, in *GetFilmDetailsRequest, opts ...grpc.CallOption) (*GetFilmDetailsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetFilmDetailsResponse)
	err := c.cc.Invoke(ctx, FilmService_GetFilmDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FilmServiceServer interface {
	GetFilmDetails(context.Context, *GetFilmDetailsRequest) (*GetFilmDetailsResponse, error)
...
func (UnimplementedFilmServiceServer) GetFilmDetails(context.Context, *GetFilmDetailsRequest) (*GetFilmDetailsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFilmDetails not implemented")
}
...
func RegisterFilmServiceServer(s grpc.ServiceRegistrar, srv FilmServiceServer) {
	// If the following call pancis, it indicates UnimplementedFilmServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _FilmService_GetFilmDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFilmDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FilmServiceServer).GetFilmDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilmService_GetFilmDetails_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FilmServiceServer).GetFilmDetails(ctx, req.(*GetFilmDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FilmService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetFilmDetails",
			Handler:    _FilmService_GetFilmDetails_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "film.proto",
